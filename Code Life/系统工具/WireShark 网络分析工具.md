...
2. 下载过程中需要确认权限：
	1. ![](https://pub-3d9f294b944b4717900bef6491b2e41c.r2.dev/2026/08/1787745934889-q6zpg8pn.webp) 
	2. 需要点击 Yes
	3. 如果上述没有点击 Yes ，可以输入以下命令 ` sudo dpkg-reconfigure wireshark-common ` 后出现以上界面，点击 Yes
3. 输入 ` sudo vim /etc/group` 命令，翻倒最下面找到  ![](https://pub-3d9f294b944b4717900bef6491b2e41c.r2.dev/2026/08/1787745935309-s5w2uurh.webp) 这种内容，需要在后面加入用户操作权限
